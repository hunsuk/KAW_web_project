if (navigator.geolocation) {
    ...
    navigator.geolocation.getCurrentPosition(function(position) {
        ...
        car_lat.push(37.623010237639974,37.69433943042704)
        car_lon.push(126.8022433746701,126.82049939110969)
        ...
        function makeClickListener(marker){
            kakao.maps.event.addListener(marker, 'click', function() {
                ...
                var url= "/request_map_popup?id=" + ID;    //팝업창에 출력될 페이지 URL
                var winWidth = 700;
                var winHeight = 600;
